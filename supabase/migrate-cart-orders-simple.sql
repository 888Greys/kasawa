-- Simple Migration: Add cart and orders tables
-- Run this migration step by step in Supabase SQL Editor
...
-- Step 6: Create trigger for order numbers
...
-- Step 8: Create triggers for timestamps
...
-- Step 10: Create RLS policies for cart_items
...
-- Step 12: Create RLS policies for order_items
...
-- Step 13: Create order details view
