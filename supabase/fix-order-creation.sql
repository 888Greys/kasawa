-- Comprehensive fix for order creation issues
...
-- Change shipping_address from TEXT to JSONB
ALTER TABLE orders 
...
-- Handle the price_at_time to price_at_purchase rename more carefully
DO $$
BEGIN
